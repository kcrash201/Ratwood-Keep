/datum/job/roguetown/veterandt
	...
	outfit = /datum/outfit/job/roguetown/veterandt
...
/datum/job/roguetown/veterandt/after_spawn(mob/living/L, mob/M, latejoin = TRUE)
	. = ..()
	if(ishuman(L))
...
/datum/outfit/job/roguetown/veterandt/pre_equip(mob/living/carbon/human/H)
	..()
