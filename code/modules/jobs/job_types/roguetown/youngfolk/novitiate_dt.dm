/datum/job/roguetown/novitiatedt
	title = "Novitiate"
	flag = NOVITIATE
	...
	outfit = /datum/outfit/job/roguetown/novitiatedt
...
/datum/outfit/job/roguetown/novitiatedt/pre_equip(mob/living/carbon/human/H)
	..()
