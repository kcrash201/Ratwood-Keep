/datum/job/roguetown/wapprenticedt
	...
	outfit = /datum/outfit/job/roguetown/wapprenticedt
...
/datum/outfit/job/roguetown/wapprenticedt/pre_equip(mob/living/carbon/human/H)
	..()
