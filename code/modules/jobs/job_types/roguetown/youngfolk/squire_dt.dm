/datum/job/roguetown/squiredt
	...
	outfit = /datum/outfit/job/roguetown/squiredt
...
/datum/job/roguetown/squiredt/after_spawn(mob/living/L, mob/M, latejoin = TRUE)
	..()
	if(ishuman(L))
...
/datum/outfit/job/roguetown/squiredt/pre_equip(mob/living/carbon/human/H)
	..()
...
/datum/subclass/squiredt/recruit
	name = "Recruit"
