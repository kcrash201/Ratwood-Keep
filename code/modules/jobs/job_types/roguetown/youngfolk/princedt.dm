/datum/job/roguetown/princedt
	...
	outfit = /datum/outfit/job/roguetown/princedt
...
/datum/job/roguetown/princedt/after_spawn(mob/living/L, mob/M, latejoin = TRUE)
	..()
	if(L)
...
/datum/job/roguetown/princedt/after_spawn(mob/living/H, mob/M, latejoin)
	. = ..()
