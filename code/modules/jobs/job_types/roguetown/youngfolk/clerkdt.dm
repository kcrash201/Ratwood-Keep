...
/datum/job/roguetown/clerkdt/after_spawn(mob/living/L, mob/M, latejoin = TRUE)
	..()
	if(L)
...
/datum/subclass/clerkdt/apprentice
	...
	outfit = /datum/outfit/job/roguetown/clerkdt/apprentice
	allowed_races = RACES_TOLERATED_UP
	category_tags = list(CTAG_CLERK)

/datum/outfit/job/roguetown/clerkdt/apprentice/pre_equip(mob/living/carbon/human/H)
	..()
	if(H.gender == MALE)
...
/datum/outfit/job/roguetown/clerkdt/assistant/pre_equip(mob/living/carbon/human/H)
	..()
	if(H.gender == MALE)
		shirt = /obj/item/clothing/suit/roguetown/shirt/undershirt/puritan
		pants = /obj/item/clothing/under/roguetown/tights
...
/datum/subclass/clerkdt/thug
	...
	outfit = /datum/outfit/job/roguetown/clerkdt/thug
	category_tags = list(CTAG_CLERK)

/datum/outfit/job/roguetown/clerkdt/thug/pre_equip(mob/living/carbon/human/H)
	..()
