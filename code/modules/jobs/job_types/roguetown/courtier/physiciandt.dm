/datum/job/roguetown/physiciandt
	...
	tutorial = "You were a child born into good wealth - But poor health. \
		...
		Now you serve in the Sultan's court ensuring the good health of those inhabiting the keep."
...
/datum/outfit/job/roguetown/physiciandt
	name = "Physician"
	jobtype = /datum/job/roguetown/physiciandt

/datum/job/roguetown/physiciandt/after_spawn(mob/living/L, mob/M, latejoin = TRUE)
	..()
	if(ishuman(L))
...
/datum/outfit/job/roguetown/physiciandt/pre_equip(mob/living/carbon/human/H)
	..()
