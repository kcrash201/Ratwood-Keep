/datum/job/roguetown/grabberdt
	...
	outfit = /datum/outfit/job/roguetown/grabberdt
...
/datum/outfit/job/roguetown/grabberdt/pre_equip(mob/living/carbon/human/H)
	..()
	if(H.gender == MALE)
...
/datum/subclass/grabber_muscledt
	name = "Muscle"
	allowed_sexes = list(MALE, FEMALE)
	outfit = /datum/outfit/job/roguetown/grabberdt/muscledt
...
/datum/outfit/job/roguetown/grabberdt/muscledt/pre_equip(mob/living/carbon/human/H)
	. = ..()
...
/datum/subclass/grabber_adherentdt
	name = "Adherent"
	allowed_sexes = list(MALE, FEMALE)
	outfit = /datum/outfit/job/roguetown/grabberdt/adherentdt
...
/datum/outfit/job/roguetown/grabberdt/adherentdt/pre_equip(mob/living/carbon/human/H)
	. = ..()
...
/datum/subclass/grabber_bouncerdt
	name = "Bouncer"
	allowed_sexes = list(MALE, FEMALE)
	outfit = /datum/outfit/job/roguetown/grabberdt/bouncerdt
...
/datum/outfit/job/roguetown/grabberdt/bouncerdt/pre_equip(mob/living/carbon/human/H)
	. = ..()
	if(H.mind)
