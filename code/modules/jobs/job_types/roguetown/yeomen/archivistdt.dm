/datum/job/roguetown/archivistdt
	title = "Scholar"
	...
	outfit = /datum/outfit/job/roguetown/archivistdt
...
/datum/outfit/job/roguetown/archivistdt
	name = "Scholar"
...
/datum/outfit/job/roguetown/archivistdt/post_equip(mob/living/carbon/human/H)
	..()
	H.virginity = TRUE
