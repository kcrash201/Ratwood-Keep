/datum/job/roguetown/architectdt
	title = "Architect"
	...
	outfit = /datum/outfit/job/roguetown/architectdt
	display_order = JDO_ARCHITECT
	min_pq = 12
	max_pq = null
	allowed_maps = list("Desert Town")
	
/datum/outfit/job/roguetown/architectdt/pre_equip(mob/living/carbon/human/H)         ///////////// fuck being a dumb virgin
	..()
