/datum/job/roguetown/prisonerbdt
	title = "Prisoner (Border)"
	flag = PRISONERB
	...
	outfit = /datum/outfit/job/roguetown/prisonerbdt
...
/datum/outfit/job/roguetown/prisonerbdt/pre_equip(mob/living/carbon/human/H)
	..()
