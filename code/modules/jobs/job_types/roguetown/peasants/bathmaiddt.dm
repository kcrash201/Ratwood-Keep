...
//Discount rogue
/datum/subclass/nightmaidendt/harlot
	name = "Harlot"
	...
	outfit = /datum/outfit/job/roguetown/nightmaidendt/harlot
	category_tags = list(CTAG_WENCH)
	maximum_possible_slots = 5
	torch = FALSE

/datum/outfit/job/roguetown/nightmaidendt/harlot/pre_equip(mob/living/carbon/human/H)
	..()
...
/datum/subclass/nightmaidendt/dominatrix
	name = "Tickler"
	...
	outfit = /datum/outfit/job/roguetown/nightmaidendt/tickler
	category_tags = list(CTAG_WENCH)
	maximum_possible_slots = 1 //I don't want the whorehouse overrun with these guys. Only one Tickler
	torch = FALSE

/datum/outfit/job/roguetown/nightmaidendt/tickler/pre_equip(mob/living/carbon/human/H)
	..()
