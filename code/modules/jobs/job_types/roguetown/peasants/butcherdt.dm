/datum/job/roguetown/butcherdt
	...
	outfit = /datum/outfit/job/roguetown/beastmasterdt
...
/datum/outfit/job/roguetown/beastmasterdt/pre_equip(mob/living/carbon/human/H)
	..()
	if(H.mind)
