/datum/job/roguetown/stewarddt
	...
	outfit = /datum/outfit/job/roguetown/stewarddt
	give_bank_account = 17
	min_pq = 2
	max_pq = null
	allowed_maps = list("Desert Town")

/datum/job/roguetown/stewarddt/after_spawn(mob/living/L, mob/M, latejoin = TRUE)
	..()
	if(ishuman(L))
...
/datum/outfit/job/roguetown/stewarddt/pre_equip(mob/living/carbon/human/H)
	..()
