/datum/job/roguetown/royalconsort
	...
	outfit = /datum/outfit/job/roguetown/royalconsort
...
/datum/job/roguetown/royalconsort/special_job_check(mob/dead/new_player/player)
	if(!player)
		return
	if(!player.ckey)
		return
...
/datum/outfit/job/roguetown/royalconsort/pre_equip(mob/living/carbon/human/H)
	. = ..()
