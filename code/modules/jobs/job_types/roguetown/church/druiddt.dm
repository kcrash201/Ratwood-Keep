/datum/job/roguetown/druiddt
	...
	outfit = /datum/outfit/job/roguetown/druiddt
...
/datum/outfit/job/roguetown/druiddt
	name = "Druid"
	jobtype = /datum/job/roguetown/druiddt
	allowed_patrons = list(/datum/patron/divine/dendor)

/datum/outfit/job/roguetown/druiddt/pre_equip(mob/living/carbon/human/H)
	..()
