...
/datum/job/roguetown/priestdt
	...
	outfit = /datum/outfit/job/roguetown/priestdt
...
/datum/job/roguetown/priestdt/after_spawn(mob/living/L, mob/M, latejoin = TRUE)
	..()
	if(ishuman(L))
...
/datum/outfit/job/roguetown/priestdt
	allowed_patrons = list(/datum/patron/divine/astrata)

/datum/outfit/job/roguetown/priestdt/pre_equip(mob/living/carbon/human/H)
	..()
	...
	H.verbs |= /mob/living/carbon/human/proc/coronate_lorddt
	H.verbs |= /mob/living/carbon/human/proc/churcheapostasydt
	H.verbs |= /mob/living/carbon/human/proc/churchannouncementdt
	H.verbs |= /mob/living/carbon/human/proc/churchexcommunicatedt
	H.verbs |= /mob/living/carbon/human/proc/completesermondt

/datum/outfit/job/roguetown/priestdt/post_equip(mob/living/carbon/human/H)
	..()
	H.virginity = TRUE

/mob/living/carbon/human/proc/coronate_lorddt()
	set name = "Coronate"
	set category = "Priest"
	if(!mind)
		return
...
/mob/living/carbon/human/proc/churcheapostasydt()
	set name = "Apostasy"
	set category = "Priest"
	if(stat)
		return
...
/mob/living/carbon/human/proc/churchexcommunicatedt()
...
/mob/living/carbon/human
	COOLDOWN_DECLARE(church_announcementdt)

/mob/living/carbon/human/proc/churchannouncementdt()
...
/mob/living/carbon/human/proc/completesermondt()
    set name = "Sermon"
    set category = "Priest"
    if(!mind)
        return
