/datum/job/roguetown/undertakerdt
	title = "Mortician"
	flag = GRAVEDIGGER
	...
	outfit = /datum/outfit/job/roguetown/undertakerdt
...
/datum/job/roguetown/undertakerdt/after_spawn(mob/living/L, mob/M, latejoin = TRUE)
	..()
	if(ishuman(L))
...
/datum/outfit/job/roguetown/undertakerdt
	allowed_patrons = list(/datum/patron/divine/necra)

/datum/outfit/job/roguetown/undertakerdt/pre_equip(mob/living/carbon/human/H)
	..()
