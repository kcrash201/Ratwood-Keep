/datum/job/roguetown/monkdt
	...
	outfit = /datum/outfit/job/roguetown/monkdt
...
/datum/job/roguetown/monkdt/after_spawn(mob/living/L, mob/M, latejoin = TRUE)
	..()
	if(ishuman(L))
...
/datum/outfit/job/roguetown/monkdt
	name = "Acolyte"
	jobtype = /datum/job/roguetown/monkdt
...
/datum/outfit/job/roguetown/monkdt/pre_equip(mob/living/carbon/human/H)
	..()
...
/datum/outfit/job/roguetown/monkdt/post_equip(mob/living/carbon/human/H)
	..()
	H.virginity = TRUE
