/datum/job/roguetown/hospitallerdt
	title = "Hospitaller"
	f_title = "Hospitaller"
	...
	outfit = /datum/outfit/job/roguetown/hospitallerdt
...
/datum/outfit/job/roguetown/hospitallerdt
	name = "Hospitaller"
	jobtype = /datum/job/roguetown/hospitallerdt
	allowed_patrons = list(/datum/patron/divine/pestra)

/datum/outfit/job/roguetown/hospitallerdt/pre_equip(mob/living/carbon/human/H)
	..()
...
/datum/job/roguetown/hospitallerdt/after_spawn(mob/living/L, mob/M, latejoin = TRUE)
	..()
	if(ishuman(L))
