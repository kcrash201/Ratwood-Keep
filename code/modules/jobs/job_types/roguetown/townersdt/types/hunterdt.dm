/datum/subclass/hunterdt
	...
	outfit = /datum/outfit/job/roguetown/townerdt/hunterdt

	category_tags = list(CTAG_TOWNERDT)

/datum/outfit/job/roguetown/townerdt/hunterdt/pre_equip(mob/living/carbon/human/H)
	..()
