/datum/subclass/fisherdt
	...
	outfit = /datum/outfit/job/roguetown/townerdt/fisherdt

	category_tags = list(CTAG_TOWNERDT)

/datum/outfit/job/roguetown/townerdt/fisherdt/pre_equip(mob/living/carbon/human/H)
	..()
	if(H.mind)
